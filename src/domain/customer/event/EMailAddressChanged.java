...
public class EMailAddressChanged implements Event {

    private CustomerId customerId;
    private EMailAddress eMailAddress;
    private ConfirmationHash confirmationHash;

    public EMailAddressChanged(CustomerId customerId, EMailAddress eMailAddress, ConfirmationHash confirmationHash) {
